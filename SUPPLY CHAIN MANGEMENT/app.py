...
def show_sales_analytics():
    ...
    # TOP 10 without "(No Code)" pollution
    _divider()
    ...
    with p3:
        ...
        if len(top_c) > 10:
            ...
            top10 = top10.append({C_CUSTOMER: "Others", C_SUBTOTAL: others_val}, ignore_index=True)
            top_c = top10
...
# ─────────────────────────────────────────────────────────────────────────────
# PURCHASE ANALYTICS TAB  (same design, cleaned No Code)
# ─────────────────────────────────────────────────────────────────────────────
def show_purchase_analytics():
    ...
    with d3:
        ...
        if len(top_v) > 10:
            ...
            top10v = top10v.append({C_VENDOR: "Others", C_SUBTOTAL: others_val}, ignore_index=True)
            top_v = top10v
